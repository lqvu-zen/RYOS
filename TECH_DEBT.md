...
| 6 | `RYOSApp` god class — ~90 methods, 2,275 lines | Architecture | **16** | 🟡 Ongoing — `quickrun`, `jobs` (`Job`, `JobRegistry`), and the `runner` worker extracted + tested; only the widget-coupled drain/`_new_job`/`_finish_job` remain |
